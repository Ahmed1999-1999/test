...
const language = {
  ar: {
    ...
    logIn: `
        ...
        <i class="fa-solid fa-arrow-left fs-4 me-2"></i>
    `,
    companyName: "تمويل التقاضي",
    companyDesc:
      "شركة تمويل التقاضي تأسست في عام 2024 لتقديم خدمات تمويل التقاضي للأفراد والشركات. نحن نؤمن بأن العدالة حق للجميع، ونسعى لدعم عملائنا في مواجهة التحديات القانونية عبر توفير تمويل موثوق وعادل.",
  ...
  en: {
    ...
    logIn: `
        ...
        <i class="fa-solid fa-arrow-right fs-4 ms-2"></i>
    `,
    companyName: "Litigation Financing",
    companyDesc:
      "Litigation Financing was established in 2024 to provide litigation financing services to individuals and businesses. We believe that justice is a right for all, and we seek to support our clients in facing legal challenges by providing reliable and fair financing.",
    ...
    termsIntroContent:
      "This website is operated by Litigation Financing, a limited liability partnership registered in the Kingdom of Saudi Arabia, with registration number [Registration Number], and whose registered office is at [Company Address] for the purposes of these terms and conditions.",
    ...
    journeyStepTwoContent:
      "Providing the necessary documents to review the feasibility and fairness of the claim by Litigation Financing.",
    ...
    footerSlogan: "Litigation Financing",
    footerRegNum: "Commercial Registration No. [************]",
    footerWho: "About Litigation Financing",
    footerTerms: "Terms and conditions",
    footerFaq: "FAQ",
    footerStart: "Start Now",
    footerContact: "Contact",
    footerCopyright:
      "All rights reserved | Litigation Financing Company © 2024",
  },
};
...
const termsAcceptanceContent = document.querySelector(
...
const termsDisclaimerContent = document.querySelector(
  ".terms-disclaimer-content"
);
const termsChangeTermsTitle = document.querySelector(".changing-terms-title");
const termsChangeTermsContent = document.querySelector(
  ".changing-terms-content"
);
const termsUpdateWebsiteTitle = document.querySelector(
  ".updating-website-title"
);
const termsUpdateWebsiteContent = document.querySelector(
  ".updating-website-content"
);
const termsSuspendWebsiteTitle = document.querySelector(
  ".suspending-website-title"
);
const termsSuspendWebsiteContent = document.querySelector(
  ".suspending-website-content"
);
const termsUsingWebsiteTitle = document.querySelector(
  ".using-our-website-title"
);
const termsUsingWebsiteContent = document.querySelector(
...
const journeyStepOnecontent = document.querySelector(
  ".journy-step-one-content"
);
const journeyStepTwoTitle = document.querySelector(".journy-step-two-title");
const journeyStepTwocontent = document.querySelector(
  ".journy-step-two-content"
);
const journeyStepThreeTitle = document.querySelector(
  ".journy-step-three-title"
);
const journeyStepThreecontent = document.querySelector(
  ".journy-step-three-content"
);
const journeyStepFourTitle = document.querySelector(".journy-step-four-title");
const journeyStepFourcontent = document.querySelector(
  ".journy-step-four-content"
);
...
const controlLanguage = (lang) => {
  ...
  termsSuspendWebsiteTitle.innerHTML = language[lang].termssuspendWebsiteTitle;
  ...
  inputEmail.placeholder = language[lang].inputEmail;
  inputPhone.placeholder = language[lang].inputNumber;
  ...
  if (
    ...
    formSuccessAlert.innerHTML =
      "نشكرك للتواصل معنا سيتم التواصل معكم فور دراسة طلبك.";
    formErrorAlert.innerHTML = "من فضلك ادخل بيانات صحيحة.";
  }
  if (document.documentElement.lang === "en") {
    formSuccessAlert.innerHTML =
      "Thank you for contacting us. We will contact you as soon as your request is reviewed.";
    formErrorAlert.innerHTML = "Please enter valid data.";
  }
